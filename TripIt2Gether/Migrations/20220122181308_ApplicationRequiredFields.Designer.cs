...
namespace TripIt2Gether.Migrations
{
    ...
    [Migration("20220122181308_ApplicationRequiredFields")]
    partial class ApplicationRequiredFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripIt2Gether.Models.Application", b =>
                {
                    ...
                    b.Property<string>("ParticipantPreviewuserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ParticipantPreviewuserId");
            ...
            modelBuilder.Entity("TripIt2Gether.ViewModels.ApplicationPreviewDataViewModel", b =>
                {
                    b.Property<string>("userId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ApplicationPreviewDataViewModel");
                });
            ...
            modelBuilder.Entity("TripIt2Gether.Models.Application", b =>
                {
                    b.HasOne("TripIt2Gether.ViewModels.ApplicationPreviewDataViewModel", "ParticipantPreview")
                        .WithMany()
                        .HasForeignKey("ParticipantPreviewuserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
